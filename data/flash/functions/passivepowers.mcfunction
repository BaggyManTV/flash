...
execute as @e[tag=speedster,tag=flashsuitoff,scores={FlashRing=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{display:{Name:"{\"text\":\"Flash Ring\",\"color\":\"red\",\"bold\":\"true\",\"italic\":\"true\"}"},Unbreakable:1b,Damage:3}}}] run function flash:suiton
execute as @e[tag=speedster,tag=flashsuitoff,scores={FlashRing=1..},nbt={Inventory:[{Slot:-106b,id:"minecraft:carrot_on_a_stick",Count:1b,tag:{display:{Name:"{\"text\":\"Flash Ring\",\"color\":\"red\",\"bold\":\"true\",\"italic\":\"true\"}"},Unbreakable:1b,Damage:3}}]}] run function flash:suiton
