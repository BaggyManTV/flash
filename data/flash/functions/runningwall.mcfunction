...
execute as @s[tag=!timefreezed] run effect give @s minecraft:levitation 1 20 true
execute as @s at @s positioned ~ ~1 ~ if block ^ ^-1 ^ #batonblocks run effect clear @s minecraft:levitation
