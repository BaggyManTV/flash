...
execute at @s[scores={Sprint=1..}] positioned ~ ~0.5 ~ run particle dust 1.000 0.255 0.071 1 ~ ~ ~ 0.3 0.5 0.3 0.3 30 normal
execute at @s[scores={Sprint=1..}] positioned ~ ~.5 ~ run particle dust 1.000 0.780 0.169 1 ~ ~ ~ 0.3 0.5 0.3 0.3 8 normal
...
execute at @s[scores={Sprint=1..}] run execute as @e[distance=..1.5,tag=!speedster] run data merge entity @s {Fire:50s}
...
effect give @s[scores={Sprint=1..}] minecraft:speed 1 27 true
...
execute if entity @s[tag=timefreezed,scores={flashcrouch=0}] run tag @s remove timefreezed
execute if entity @s[tag=timefreezed,scores={Food=..6}] run tag @s remove timefreezed
